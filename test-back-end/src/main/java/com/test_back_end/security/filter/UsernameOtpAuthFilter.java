...
public class UsernameOtpAuthFilter extends AbstractAuthenticationProcessingFilter {

    private final SuccessHandler successHandler;
    private final FailedHandler failedHandler;
    private final ObjectMapper objectMapper;

    public UsernameOtpAuthFilter(String defaultFilterProcessesUrl, SuccessHandler successHandler, FailedHandler failedHandler, ObjectMapper objectMapper) {
